...
import com.salik.nobrokerapp.adapter.orderAdapter
...
class ViewOrder : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userRecyclerview1 = findViewById(R.id.userList1)
    ...
    private fun getUserData() {
        ...
        dbref =FirebaseDatabase.getInstance().getReferenceFromUrl(Uri.parse("https://nobroker-e81fc-default-rtdb.firebaseio.com/user/"+uuid+"/purchase")
            .toString())
        ...
        dbref.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    userRecyclerview1.adapter = orderAdapter(userArrayList1)
